...
eqns_mat_form = [ TETAD_ACT TETADD_ACT TETAD_INT TETADD_INT TETAD_EXT TETADD_EXT TETAD_H TETADD_H];
vars_mat_form = [ teta_act tetad_act teta_int tetad_int teta_ext tetad_ext teta_h tetad_h  ];
...
Plant = ss(A,B,C,D)
Q = 1; % A number greater than zero
R = .5*diag(ones(1,1)); % A number greater than zero
